// 自包含图标组件（源：lucide-static v1.28.0, ISC License）——与 lucide 同款线条风格
// React 版本：无外部依赖，SSR/hydrate 完全兼容
...
function Icon(p: IconProps & { children: ReactNode }) {
  const { size = 15, className: cls, color, strokeWidth = 2, style } = p;
  return (
    <svg
